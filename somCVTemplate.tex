...
\usepackage{color,colordvi,textcomp,graphicx}
\usepackage{array}
...
% don't want boxes around links but change their color
\usepackage[colorlinks=true,linkcolor=color3,anchorcolor=color3,urlcolor=color3,citecolor=color0]{hyperref}
...
\subsection*{Media Releases or Interviews [MR]}
